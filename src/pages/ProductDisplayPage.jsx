  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <h2 className='font-semibold'>Chính Sách Hậu Mãi </h2>
            <div>
                  <div className='flex  items-center gap-4 my-4'>
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Chúng tôi bảo hành 12 tháng và hỗ trợ sữa chữa</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      />
                      <div className='text-sm'>
                        <div className='font-semibold'>Đội Ngũ</div>
                        <p>Đội ngũ nhân chắm sóc bao gồm tổng đài và nhân viên kỹ thuật di động.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Giá tốt cho khách hàng thân thiết</p>
                      </div>
                  </div>
            </div>
